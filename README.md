...
The URLs that we'll need for our pages are:
    ...
    category/author/<pk> — The detail view for the specific author with a primary key field of <id>.  For example, the URL for the 11th author added to the list will be  /catalog/author/11.
